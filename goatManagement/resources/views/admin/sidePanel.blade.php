    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ URL::to('/admin') }}">Firm Mangement</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Goat Info<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ URL::to('/add-goat') }}">Add Goat</a>
                                </li>
                                <li>
                                    <a href="{{ URL::to('/all-goat') }}">All Goat</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                         <li>
                            <a href="#"><i class="fa fa-wrench fa-fw"></i> Buck Info<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ URL::to('/add-buck') }}">Add Buck</a>
                                </li>
                                <li>
                                    <a href="{{ URL::to('/all-buck') }}">All Buck</a>
                                </li>
                        ...
                        <li>
                            <a href="{{ URL::to('/breading') }}"><i class="fa fa-dashboard fa-fw"></i> Breading</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-wrench fa-fw"></i> Delivery Info<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ URL::to('/mother-info') }}">Mother Info</a>
                                </li>
                                <li>
                                    <a href="{{ URL::to('/pregnant-goat') }}">Pregnant Goat</a>
                                </li>
                                <li>
                                    <a href="{{ URL::to('/kids-info') }}">Kids Info</a>
                                </li>
                         ...
                         <li>
                            <a href="#"><i class="fa fa-wrench fa-fw"></i> Medication<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ URL::to('/vaccines') }}">Vaccines</a>
                                </li>
                                <li>
                                    <a href="{{ URL::to('/other-treatment') }}">Other Treatment</a>
                                </li>
                                <li>
                                    <a href="{{ URL::to('/vaccines-info') }}">Vaccines Info</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                         <li>
                            <a href="{{ URL::to('/death-goat') }}"><i class="fa fa-dashboard fa-fw"></i> Death Goat</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
